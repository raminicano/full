...
app.get('/dbTestInsert', function (req, res) {
    oracledb.getConnection(
        {
            user: dbConfig.user,
            password: dbConfig.password,
        ...
        function (err, connection) {
            ...
            let query = "insert into usertbl(userid, username, birthyear, addr, mobile1, mobile2, height, mdate)" + 'values(:userid, :username, :birthyear, :addr, :mobile1, :mobile2, :height, :mdate)';
